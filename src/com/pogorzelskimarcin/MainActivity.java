...
public class MainActivity extends ActionBarActivity {
	...
	public void DodajPolow(View view)
	{
		Intent intent = new Intent(this, DodajPolowActivity.class);
		startActivity(intent);	
	}
	
	public void ListaPolowow(View view)
	{
		Intent intent = new Intent(this, ListaPolowow.class);
		startActivity(intent);
	}
	
	public void ZaznaczMiejsce(View view)
	{
		Intent intent = new Intent(this, MyMap.class);
		startActivity(intent);
	}
	
	public void ListaMiejsc(View view)
	{
